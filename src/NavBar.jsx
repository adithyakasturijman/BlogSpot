      ...
      <div className="flex items-center justify-between h-16 px-2 ml-8 mr-8">
        <div className="flex items-center ">
          ...
          <li className="flex items-center space-x-2">
            ...
            <a href="/" className="text-md font-medium text-white hover:text-gray-300 font-mono">Home</a>
          </li>
          <li className="flex items-center space-x-2">
            <img src="/groups_24dp_FFFFFF_FILL0_wght400_GRAD0_opsz24.png" className="w-5 h-5" alt="About" />
            <a href="/about" className="text-md font-medium text-white hover:text-gray-300 font-mono">About</a>
          </li>
          <li className="flex items-center space-x-2">
            <img src="/contact_page_24dp_FFFFFF_FILL0_wght400_GRAD0_opsz24.png" className="w-5 h-5" alt="Contact" />
            <a href="/contact" className="text-md font-medium text-white hover:text-gray-300 font-mono">Contact</a>
          </li>
          <li className="flex items-center space-x-2">
            <img src="/contact_page_24dp_FFFFFF_FILL0_wght400_GRAD0_opsz24.png" className="w-5 h-5" alt="Contact" />
            <a href="/blogs" className="text-md font-medium text-white hover:text-gray-300 font-mono">Blogs</a>
          </li>
        </ul>
          </div>
        </div>
        ...
        <div className="hidden sm:flex space-x-4 ml-8">
          <a href="/login" className="bg-[#36454F] text-white px-4 py-1 rounded-full hover:bg-gray-600 font-mono">Login</a>
          <a href="/signup" className="bg-[#36454F] text-white px-4 py-1 rounded-full hover:bg-gray-600 font-mono">Signup</a>
